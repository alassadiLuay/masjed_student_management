...
class FillPermissionsForTeacherRole extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTeacherRole constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.teacher-role',
            'admin.teacher-role.index',
            'admin.teacher-role.create',
            'admin.teacher-role.show',
            'admin.teacher-role.edit',
            'admin.teacher-role.delete',
        ]);
