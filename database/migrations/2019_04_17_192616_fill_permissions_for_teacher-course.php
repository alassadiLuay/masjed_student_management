...
class FillPermissionsForTeacherCourse extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTeacherCourse constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.teacher-course.index',
            'admin.teacher-course.create',
            'admin.teacher-course.show',
            'admin.teacher-course.edit',
            'admin.teacher-course.delete',
        ]);
