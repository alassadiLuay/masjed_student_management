...
class FillPermissionsForCourseTeacherStudent extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCourseStudent constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.course-student.index',
            'admin.course-student.create',
            'admin.course-student.show',
            'admin.course-student.edit',
            'admin.course-student.delete',
        ]);
