...
class FillPermissionsForPointConfig extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPointConfig constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.point-config',
            'admin.point-config.index',
            'admin.point-config.create',
            'admin.point-config.show',
            'admin.point-config.edit',
            'admin.point-config.delete',
        ]);
