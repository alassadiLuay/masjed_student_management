...
class FillPermissionsForStudentPoint extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForStudentPoint constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.student-point',
            'admin.student-point.index',
            'admin.student-point.create',
            'admin.student-point.show',
            'admin.student-point.edit',
            'admin.student-point.delete',
        ]);
