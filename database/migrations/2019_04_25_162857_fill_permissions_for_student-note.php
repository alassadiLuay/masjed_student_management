...
class FillPermissionsForStudentNote extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForStudentNote constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.student-note',
            'admin.student-note.index',
            'admin.student-note.create',
            'admin.student-note.show',
            'admin.student-note.edit',
            'admin.student-note.delete',
        ]);
