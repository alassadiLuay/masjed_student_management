...
class FillPermissionsForPointType extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPointType constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.point-type',
            'admin.point-type.index',
            'admin.point-type.create',
            'admin.point-type.show',
            'admin.point-type.edit',
            'admin.point-type.delete',
        ]);
