...
class FillPermissionsForAwqafStudent extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAwqafStudent constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.awqaf-student',
            'admin.awqaf-student.index',
            'admin.awqaf-student.create',
            'admin.awqaf-student.show',
            'admin.awqaf-student.edit',
            'admin.awqaf-student.delete',
        ]);
