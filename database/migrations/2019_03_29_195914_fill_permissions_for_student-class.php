...
class FillPermissionsForStudentClass extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForStudentClass constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.student-class',
            'admin.student-class.index',
            'admin.student-class.create',
            'admin.student-class.show',
            'admin.student-class.edit',
            'admin.student-class.delete',
        ]);
