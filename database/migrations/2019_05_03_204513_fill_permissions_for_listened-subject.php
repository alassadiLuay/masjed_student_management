...
class FillPermissionsForListenedSubject extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForListenedSubject constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.listened-subject',
            'admin.listened-subject.index',
            'admin.listened-subject.create',
            'admin.listened-subject.show',
            'admin.listened-subject.edit',
            'admin.listened-subject.delete',
        ]);
