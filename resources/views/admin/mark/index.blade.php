...
@section('title', trans('admin.mark.actions.index'))
            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> {{ trans('admin.mark.actions.index') }}
                        <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0" href="{{ url('admin/marks/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp; {{ trans('admin.mark.actions.create') }}</a>
                    </div>
                    <div class="card-body" v-cloak>
                        ...
                        <table class="table table-hover table-listing">
                            <thead>
                                <tr>
                                    ...
                                    <th is='sortable' :column="'exam_name'">exam_name</th>
                                    <th is='sortable' :column="'mark'">exam_mark</th>
                                    <th is='sortable' :column="'notes'">notes</th>
	                    ...
	                    <div class="no-items-found" v-if="!collection.length > 0">
                            ...
                            <a class="btn btn-primary btn-spinner" href="{{ url('admin/marks/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp; {{ trans('admin.mark.actions.create') }}</a>
	                    </div>
                    </div>
                </div>
            </div>
