            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0" href="{{ url('admin/courses/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp; {{ trans('admin.course.actions.create') }}</a>
                    </div>
                    <div class="card-body" v-cloak>
                        ...
                        <table class="table table-hover table-listing">
                            <thead>
                                <tr>
                                    ...
                                    <th is='sortable' :column="'started_at'">{{ trans('admin.course.columns.started_at') }}</th>
                                    <th is='sortable' :column="'end_at'">{{ trans('admin.course.columns.end_at') }}</th>
                                    <th is='sortable' :column="'session_number'">عدد الطلاب المسجلين</th>
                                    <th is='sortable' :column="'session_number'">{{ trans('admin.course.columns.session_number') }}</th>
	                    ...
	                    <div class="no-items-found" v-if="!collection.length > 0">
                            ...
                            <a class="btn btn-primary btn-spinner" href="{{ url('admin/courses/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp; {{ trans('admin.course.actions.create') }}</a>
	                    </div>
                    </div>
                </div>
            </div>
